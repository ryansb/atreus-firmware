int layer0[44] = {
    KEY_Q, KEY_W, KEY_D, KEY_F, KEY_K, KEY_0, KEY_J, KEY_U, KEY_R, KEY_L, KEY_SEMICOLON,
    KEY_A, KEY_S, KEY_E, KEY_T, KEY_G, KEY_0, KEY_Y, KEY_N, KEY_I, KEY_O, KEY_H,
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_ENTER, KEY_P, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
    KEY_ESC, KEY_TAB, KEY_MINUS, KEYBOARD_LEFT_SHIFT, KEY_BACKSPACE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), KEYBOARD_LEFT_GUI, KEY_QUOTE, KEYBOARD_LEFT_ALT };
...
int layer1[44] = {
    ...
    FUNCTION(2), SHIFT(KEY_INSERT), ALT(KEY_TAB), KEYBOARD_LEFT_SHIFT, KEY_DELETE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), KEY_PERIOD, KEY_0, KEY_EQUAL };
...
int layer2[44] = {
    ...
    CTRL(ALT(KEY_LEFT)), 0, CTRL(ALT(KEY_RIGHT)), 0, 0, KEYBOARD_LEFT_ALT, 0, KEY_F1, KEY_F2, KEY_F3, KEY_F12,
